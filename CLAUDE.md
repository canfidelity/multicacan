...
Multicacan is an AI-native task management platform — like Linear, but with AI agents as first-class citizens.
...
make cli ARGS="..."   # Run multicacan CLI (e.g. make cli ARGS="config")
make test             # Go tests
