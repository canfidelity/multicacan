#!/usr/bin/env node
// Builds the `multicacan` CLI from server/cmd/multicacan and copies the binary
...
//
// ldflags mirror `make build` so `multicacan --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "multicacan.exe" : "multicacan";
}
