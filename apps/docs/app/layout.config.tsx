...
// Docs-local stateless Multicacan mark — matches @multicacan/ui's MulticacanIcon
...
// packages/ui/components/common/multicacan-icon.tsx if the mark changes.
const MULTICACAN_CLIP = `polygon(
...
// desktop). Leading icon = brand identity (GitHub mark / Multicacan asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">Multicacan Docs</span>
    ),
  },
  links: [
    {
    ...
    {
      icon: <MulticacanMark />,
      text: externalLinkText("Multicacan"),
