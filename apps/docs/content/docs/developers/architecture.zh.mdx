---
title: Architecture
description: Technical architecture of the Multicacan platform.
---

## Overview

Multicacan is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `multicacan` (CLI + daemon), `migrate`
