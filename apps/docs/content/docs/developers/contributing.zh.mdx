---
title: Contributing
description: Local development workflow for contributors working on the Multicacan codebase.
---
...
| | Main | Worktree |
|---|---|---|
| Database | `multicacan` | `multicacan_my_feature_702` |
...
```bash
docker compose exec -T postgres psql -U multicacan -d postgres \
