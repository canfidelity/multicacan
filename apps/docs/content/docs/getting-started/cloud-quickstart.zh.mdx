...
description: Get started with Multicacan Cloud — no setup required.
---

The fastest way to get started with Multicacan — no setup required.

## 1. Sign up

Go to [multicacan.ai](https://multicacan.ai) and create an account.
...
```
Fetch https://github.com/multicacan-ai/multicacan/blob/main/CLI_INSTALL.md and follow the instructions to install Multicacan CLI, log in, and start the daemon on this machine.
```
