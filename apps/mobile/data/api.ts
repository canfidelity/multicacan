 ...
 *
 * Types are imported via `import type` from @multicacan/core/types — zero
 * runtime coupling. Zod schemas + fallbacks are imported from
 * @multicacan/core/api/schemas (pure data, on the mobile sharing whitelist).
 *
...
} from "@multicacan/core/api/schemas";
import {
