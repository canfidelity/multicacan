 ...
 * yet schematised in @multicacan/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@multicacan/core/api/schemas";
...
// availability derivation in @multicacan/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@multicacan/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
