 ...
 * `@multicacan/core/issues/stores/issues-scope-store` — mobile only
 * `import type` from `@multicacan/core/types/*` per Sharing Principles, and
...
import type { IssuePriority, IssueStatus } from "@multicacan/core/types";
