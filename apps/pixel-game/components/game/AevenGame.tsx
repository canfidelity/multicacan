...
export default function AevenGame({ onExit }: Props) {
  ...
  useEffect(() => {
    ...
    const onLoad = () => {
      try {
        ...
        // Mobile soft-keyboard fix (same as standalone index.html)
  ...
  return (
    <div style={{ position: 'relative', width: '100%', background: '#1e1e28' }}>
      {/* Exit button overlay */}
      <button
        onClick={onExit}
        style={{
