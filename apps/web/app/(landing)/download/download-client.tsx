...
import { captureDownloadPageViewed } from "@multicacan/core/analytics";

const ALL_RELEASES_URL =
  "https://github.com/canfidelity/multicacan/releases";
  ...
  return (
    <>
      {/* Positioning context for the dark-variant LandingHeader —
          mirrors multicacan-landing.tsx. The header is `absolute top-0
