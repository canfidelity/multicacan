...
export const metadata: Metadata = {
  title: "Download Multicacan",
  description:
    "Download Multicacan for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Multicacan",
    description:
      "Get the Multicacan desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
