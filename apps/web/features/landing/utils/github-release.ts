...
/**
 * Server-side fetcher for the latest Multicacan release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/canfidelity/multicacan/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — Multicacan doesn't publish prereleases or drafts
