 ...
 *   multicacan-desktop-{version}-mac-{arch}.{dmg|zip}
 *   multicacan-desktop-{version}-windows-{arch}.exe
 *   multicacan-desktop-{version}-linux-{arch}.{AppImage|deb|rpm}
 *
...
const DESKTOP_ARTIFACT_RE =
  /^multicacan-desktop-[^-]+-(mac|windows|linux)-([a-z0-9_]+)\.(dmg|zip|exe|AppImage|deb|rpm)$/i;
