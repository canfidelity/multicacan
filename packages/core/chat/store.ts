...
const AGENT_STORAGE_KEY = "multicacan:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "multicacan:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "multicacan:chat:drafts";
/** Placeholder sessionId for a chat that hasn't been created yet. */
export const DRAFT_NEW_SESSION = "__new__";
const CHAT_WIDTH_KEY = "multicacan:chat:width";
const CHAT_HEIGHT_KEY = "multicacan:chat:height";
const CHAT_EXPANDED_KEY = "multicacan:chat:expanded";
/** Focus mode is a personal preference — global across workspaces/sessions. */
const FOCUS_MODE_KEY = "multicacan:chat:focusMode";
/**
 ...
 */
const OPEN_KEY = "multicacan:chat:isOpen";
