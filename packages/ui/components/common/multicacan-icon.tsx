...
interface MulticacanIconProps extends React.ComponentProps<"span"> {
  /**
...
/**
 * Pure CSS 8-pointed asterisk icon matching the Multicacan logo.
 ...
 */
export function MulticacanIcon({
  className,
  animate = false,
  noSpin = false,
  bordered = false,
