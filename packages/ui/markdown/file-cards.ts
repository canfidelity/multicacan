 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "multicacan-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "multicacan-static.copilothub.ai")
 */
