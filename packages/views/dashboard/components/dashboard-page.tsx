...
import { projectListOptions } from "@multicacan/core/projects/queries";
import {
  dashboardUsageDailyOptions,
  dashboardUsageByAgentOptions,
  dashboardAgentRunTimeOptions,
  dashboardRunTimeDailyOptions,
} from "@multicacan/core/dashboard";
import { useCustomPricingStore } from "@multicacan/core/runtimes/custom-pricing-store";
...
const EMPTY_DAILY: import("@multicacan/core/types").DashboardUsageDaily[] = [];
const EMPTY_BY_AGENT: import("@multicacan/core/types").DashboardUsageByAgent[] = [];
const EMPTY_RUNTIME: import("@multicacan/core/types").DashboardAgentRunTime[] = [];
const EMPTY_RUNTIME_DAILY: import("@multicacan/core/types").DashboardRunTimeDaily[] = [];
