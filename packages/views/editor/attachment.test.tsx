...
import type { Attachment as AttachmentRecord } from "@multicacan/core/types";
...
vi.mock("@multicacan/core/paths", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@multicacan/core/paths")>();
  return {
    ...actual,
