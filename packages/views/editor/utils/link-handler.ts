...
import { isGlobalPath } from "@multicacan/core/paths";
...
/**
 * Open a link — internal paths dispatch multicacan:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("multicacan:navigate", { detail: { path } }),
    );
  } else {
