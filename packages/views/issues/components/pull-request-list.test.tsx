...
import type { GitHubPullRequest } from "@multicacan/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@multicacan/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@multicacan/core/github/queries")>(
    "@multicacan/core/github/queries",
  );
  return {
    ...actual,
