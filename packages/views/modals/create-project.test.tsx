...
vi.mock("@multicacan/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@multicacan/core/projects", () => ({
...
vi.mock("@multicacan/ui/components/ui/popover", () => ({
...
vi.mock("@multicacan/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
