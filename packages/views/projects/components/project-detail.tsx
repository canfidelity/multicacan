...
import { PROJECT_STATUS_ORDER, PROJECT_STATUS_CONFIG, PROJECT_PRIORITY_ORDER } from "@multicacan/core/projects/config";
...
import { ProjectRoadmapSection } from "./project-roadmap-section";
...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  const sidebarContent = (
    <div className="space-y-5">
      ...
      {/* Roadmap */}
      <ProjectRoadmapSection wsId={wsId} project={project} />
