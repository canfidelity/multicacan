...
vi.mock("@multicacan/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@multicacan/core/github")>("@multicacan/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Multicacan will stop receiving webhooks/i)).toBeTruthy();
