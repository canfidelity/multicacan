...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.example.com"
	cookieDomain string // cookie scope, e.g. ".example.com"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.example.com")
//   - COOKIE_DOMAIN           (e.g. ".example.com")
