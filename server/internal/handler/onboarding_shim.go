...
Your full capability surface = whatever ` + "`multicacan --help`" + ` shows. Run ` + "`multicacan --help`" + ` first, then ` + "`multicacan <command> --help`" + ` for any subcommand; use ` + "`--output json`" + ` for structured data. The CLI is your manifest — never invent commands or flags.
