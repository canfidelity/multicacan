...
const getLastAgentCommentOnIssue = `-- name: GetLastAgentCommentOnIssue :one
...
func (q *Queries) GetLastAgentCommentOnIssue(ctx context.Context, issueID pgtype.UUID) (pgtype.UUID, error) {
	row := q.db.QueryRow(ctx, getLastAgentCommentOnIssue, issueID)
